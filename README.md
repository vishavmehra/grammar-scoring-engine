\# 🗣️ AI-Powered Grammar Scoring Engine
...
1\.  \*\*Preprocessing:\*\* \* Audio resampling to 16kHz.
...
&nbsp;   \* \*\*XGBoost:\*\* Trains on the reduced feature set with heavy regularization (`subsample=0.7`, `max\_depth=3`).
